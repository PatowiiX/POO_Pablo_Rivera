...
public class Vista {
    ...
    private GestorAlumno gestorAlumno; // Nuevo gestor para alumnos
        ...
        while (true) {
            ...
            switch (opcion) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    mostrarPagos(); // Llamar al método para mostrar pagos
                    break;
                case 6:
                    mostrarAlumnos();
                    break;
    ...
    private void agregarProfesor() {
        ...
        gestorPagos.agregarProfesor(profesor); // Agregar el profesor a GestorPagos
    ...
    private void agregarAlumno() {
        ...
        gestorAlumno.agregarAlumno(alumno); // Agregar a la lista de alumnos
    ...
    private void eliminarAlumno() {
        ...
        for (Alumno alumno : gestorAlumno.getAlumnos()) {
            if (alumno.getMatricula().equals(matricula)) {
                gestorAlumno.eliminarAlumno(matricula); // Método para eliminar alumno
                encontrado = true;
                break;
            }
        }
    ...
    private void agregarCurso() {
        ...
        Curso curso = new Curso(nombreCurso, materias); // Crear el curso con el arreglo de materias
